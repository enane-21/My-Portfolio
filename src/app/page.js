...
import { Mail, Phone, MapPin, Briefcase, GraduationCap, Download } from "lucide-react";
...
const PROJECTS = [
  {
    ...
    github: "https://github.com/enane-21/Brokery-system",
    caseStudy: [
      {
        heading: "Overview",
    ...
    <main className="bg-slate-900 text-slate-100 min-h-screen">
      ...
      <header className="max-w-5xl mx-auto px-6 py-24 flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="shrink-0">
          <div className="relative w-44 h-44 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-emerald-500 shadow-[0_0_40px_rgba(52,211,153,0.35)]">
            <Image
              src="/my-photo.jpg"
        ...
        <div className="flex flex-col gap-4 text-center md:text-left">
          ...
          <span className="text-slate-400 font-mono text-sm">Hi, my name is</span>
          ...
          <p className="text-slate-400 max-w-xl leading-relaxed text-sm">
            Computer Science graduate (CGPA 3.8) from Debre Tabor University.
            I build scalable full-stack systems and I&apos;m actively growing toward
            cloud-native, TypeScript-first development. Open to opportunities worldwide.
          </p>
          ...
          <div className="flex flex-wrap gap-3 pt-2 justify-center md:justify-start">
            ...
            <a
              href="#contact"
              className="border border-slate-700 hover:border-slate-500 px-6 py-3 rounded-lg transition-colors flex items-center gap-2 text-sm"
            >
              <Mail size={16} /> Contact Me
            </a>
            <a
              href="/MENGISTU ANIMUT BOGALE.pdf"
              download="Mengistu_Animut_Bogale_CV.pdf"
              className="border border-emerald-700 hover:bg-emerald-500 hover:text-slate-950 hover:border-emerald-500 text-emerald-400 px-6 py-3 rounded-lg transition-all flex items-center gap-2 text-sm font-medium"
            >
      ...
      >
        ...
        <p className="text-slate-400 text-sm mb-8">Real systems built and shipped — click &quot;Case Study&quot; to explore the architecture.</p>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 border-t border-slate-800 grid md:grid-cols-2 gap-12">
        <div>
          ...
          <div className="border-l-2 border-emerald-900 pl-4 space-y-2">
      ...
      <footer className="max-w-5xl mx-auto px-6 py-12 border-t border-slate-800 text-center text-slate-500 text-sm space-y-5">
        ...
        <SocialLinks />
        <p>
          © {new Date().getFullYear()} Mengistu Animut Bogale. Built with Next.js &amp; Tailwind CSS.
        </p>
      </footer>
    </main>
  );
